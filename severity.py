...
CHECKPOINT_NAME = './severity_checkpoint'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--output_graph',
        type=str,
        default='./s_output_graph.pb',
        help='Where to save the trained graph.'
    )
    parser.add_argument(
        '--intermediate_output_graphs_dir',
        type=str,
        default='./s_intermediate_graph/',
    ...
    parser.add_argument(
        '--saved_model_dir',
        type=str,
        default='./models/severity/$(date +%s)/',
